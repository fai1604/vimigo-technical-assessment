...
The following table lists the available endpoints for this API:

| HTTP Verb | Endpoint                  | Action                                        |
|-----------|---------------------------|-------------------------------------------------|
| GET       | /contacts/:name           | Retrieve a specific contact by name            |
| POST      | /contacts                 | Create a new contact                           |
| PUT       | /contacts                 | Update an existing contact                     |
| DELETE    | /contacts/:name           | Delete a specific contact by name              |
| GET       | /contacts/all             | Retrieve all contacts in alphabetical order   |
| GET       | /contacts/recent          | Retrieve the 5 recently created contacts       |
| GET       | /contacts/email/:email    | Retrieve a specific contact by email address   |
| GET       | /contacts/gender/:gender  | Retrieve all contacts with specified gender    |

Note: All endpoints return JSON objects.
